...
{   
    ...
    [self addSubview:_prePageButton];
...
- (void)layoutSubviews
{
    ...
    if (_needsAdjustingViewFrame) {
        ...
        _prePageButton.frame = CGRectMake((self.fs_width - 144)/2, headerHeight*0.1, 30, headerHeight*0.9);
        _nextPageButton.frame = CGRectMake(self.fs_width - (self.fs_width - 144)/2 - 30, headerHeight*0.1, 30, headerHeight*0.9);
